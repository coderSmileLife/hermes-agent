...
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/coderSmileLife/hermes-agent/main/scripts/install.sh | bash
#
# Or with options:
...
# Configuration
REPO_URL_SSH="git@github.com:coderSmileLife/hermes-agent.git"
REPO_URL_HTTPS="https://github.com/coderSmileLife/hermes-agent.git"
...
detect_os() {
    case "$(uname -s)" in
        ...
        CYGWIN*|MINGW*|MSYS*)
            ...
            log_info "  irm https://raw.githubusercontent.com/coderSmileLife/hermes-agent/main/scripts/install.ps1 | iex"
            exit 1
            ;;
        *)
            OS="unknown"
